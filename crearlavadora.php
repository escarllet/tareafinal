                        ...
                        <div class="card bg-secondary shadow">
                            <div class="card-header bg-white border-1">
                                <div class="row align-items-center">
                                    <div class="col-12">
                                        <h3 class="mb-0">Agregar Lavadora</h3>
                                    </div>
                                </div>
                            </div>

                            <div class="card-body">
                             <form action="crudlavadora/save.php?id=<?php echo $id?>" method="POST" autocomplete="off">
                                    <!-- Address -->
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" class="form-control" name="lcodigo" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" class="form-control" name="lmarca" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" class="form-control" name="lmodelo" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <div class="input-group">
                                                            ...
                                                            <input type="number" class="form-control" name="lvalor" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <div class="input-group">
                                                            ...
                                                            <input type="number" class="form-control" name="lpeso" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="container-fluid d-flex align-items-center">
                                        ...
                                        <button type="submit" name="save" class="btn btn-success btn-lg btn-block">Guardar informacion</button>
