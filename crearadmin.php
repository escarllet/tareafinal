                        ...
                        <div class="card bg-secondary shadow">
                            <div class="card-header bg-white border-1">
                                <div class="row align-items-center">
                                    <div class="col-12">
                                        <h3 class="mb-0">Agregar Administrador</h3>
                                    </div>
                                </div>
                            </div>

                            <div class="card-body">
                             <form action="crudadmin/save.php" method="POST" autocomplete="off">

                                    <h6 class="heading-small text-muted mb-4">Informacion del nuevo administrador</h6>
                                    <div class="pl-lg-4">
                                        <div class="row">
                                            <div class="col-lg-6">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="email" class="form-control" name="correo" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-lg-12">
                                                <div class="form-group">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="password" class="form-control" name="pass" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
